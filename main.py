...
SERPER_API_KEY = os.getenv("SERPER_API_KEY", "dd988eff14b900767ed4095286c6bc0809e2ebd4b121a28faaeda59c1d301a24")
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyBxcGj21R26W6kY7lwpCqFMiDDXs7yxYUM")
...
def main():
    ...
    try:
        ...
        for result in scraped_results:
            summary = summarize_with_gemini(result['content'])
            output["summaries"].append({
                "title": result["title"],
                "url": result["url"],
                "summary": summary
            })
            output["sources"].append(result["url"])
